...
```{r}
lib_key <- read_tsv("~/Documents/MPRA/Cancer_MPRA/Lx_Analysis/ref_alt_snp_table.txt")
```
...
merged_rs <- read_tsv("~/Documents/MPRA/Cancer_MPRA_Scaleup/AnalysisFiles12.5.19/FormattingBackground/MergingSNPs/RsMergeArch.bcp",
...
# write_tsv(merged_rs, "~/Documents/MPRA/Cancer_MPRA_Scaleup/AnalysisFiles12.5.19/FormattingBackground/MergingSNPs/RsMerge_libSNPsOnly.tsv")
```
...
That's a lot fewer than I thought.
...
write_tsv(merged_rsid_conversion, "~/Documents/MPRA/Cancer_MPRA_Scaleup/AnalysisFiles12.5.19/FormattingBackground/MergingSNPs/lib_snps_merged_rsid_conversion.tsv")
```
...
write_tsv(merged_lib, "~/Documents/MPRA/Cancer_MPRA_Scaleup/AnalysisFiles12.5.19/FormattingBackground/lib_table_merged_rsids_12.10.19.tsv")
```
